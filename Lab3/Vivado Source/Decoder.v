...
module Decoder(
    ...
    output reg [1:0] ALUControl, // 00 for anything that is not DP, 00 for ADD, 01 for SUB, 10 for AND, 11 for ORR
    ...
    always @(*) begin
        ...
        if (ALUOp[1]) begin //Set the corresponding ALUControl and FlagW values by their specific DP Instruction if ALUOp[1] is 1
            ...
            case(Funct[4:0])
                 5'b01000: begin //DP ADD Instr
                    ALUControl = 2'b00; //Denotes ADD Instr
                 ...
                 5'b00100: begin //DP SUB Instr
                    ALUControl = 2'b01; //Denotes SUB Instr
                    FlagW = 2'b00; //Dont save any flags
                 end
                 ...
                 if(bit7to4 == 4'b1001) begin //DP MUL Instr
                    ...
                    ALUControl = 2'b10; //Denotes AND Instr
                    FlagW = 2'b00; //Dont save any flags
                    end
                 end
                 ...
                 5'b11000: begin //DP ORR Instr
                    ALUControl = 2'b11; //Denotes ORR Instr
                    FlagW = 2'b00; //Dont save any flags
                 end
        ...
        controls[0] = (Funct[4:0] == 5'b10101 || Funct[4:0] == 5'b10111) ? 1'b1 : 1'b0; //NoWrite if its CMP or CMN then 1 else 0
